...
export class PagerRequest extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.pageNumber != 0)
            writer.writeUint32(1, this.pageNumber);
        if (this.pageSize != 0)
            writer.writeUint32(2, this.pageSize);
        if (this.sorts.length)
            writer.writeRepeatedMessage(3, this.sorts, (item: Sort) => item.serialize(writer));
        if (!w)
            return writer.getResultBuffer();
    }
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): PagerRequest {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new PagerRequest();
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    reader.readMessage(message.sorts, () => pb_1.Message.addToRepeatedWrapperField(message, 3, Sort.deserialize(reader), Sort));
                    break;
...
export class PagerResponse extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.sorts.length)
            writer.writeRepeatedMessage(4, this.sorts, (item: Sort) => item.serialize(writer));
        if (!w)
            return writer.getResultBuffer();
    }
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): PagerResponse {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new PagerResponse();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
                ...
                case 3:
                    ...
                    break;
                case 4:
                    reader.readMessage(message.sorts, () => pb_1.Message.addToRepeatedWrapperField(message, 4, Sort.deserialize(reader), Sort));
                    break;
                default: reader.skipField();
            }
        }
...
export class Sort extends pb_1.Message {
    ...
    get direction() {
        return pb_1.Message.getFieldWithDefault(this, 2, dependency_1.Direction._Direction_UNSPECIFIED) as dependency_1.Direction;
    }
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): Sort {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new Sort();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
