...
export class TimeRange extends pb_1.Message {
  ...
  serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
    ...
    if (this.start != 0) writer.writeInt64(1, this.start);
    if (this.end != 0) writer.writeInt64(2, this.end);
...
export class CRUDResult extends pb_1.Message {
  ...
  static fromObject(data: { value?: boolean }): CRUDResult {
...
export class StringResult extends pb_1.Message {
  ...
  static fromObject(data: { value?: string }): StringResult {
...
export class StringRequest extends pb_1.Message {
  ...
  static fromObject(data: { value?: string }): StringRequest {
...
export class DeleteBatchRequest extends pb_1.Message {
  ...
  static fromObject(data: { ids?: string[] }): DeleteBatchRequest {
  ...
  static deserialize(
    ...
    const reader =
        bytes instanceof pb_1.BinaryReader
          ? bytes
          : new pb_1.BinaryReader(bytes),
      message = new DeleteBatchRequest();
    while (reader.nextField()) {
      if (reader.isEndGroup()) break;
      switch (reader.getFieldNumber()) {
        case 1:
...
export class BatchIntRequest extends pb_1.Message {
  ...
  static fromObject(data: { ids?: number[] }): BatchIntRequest {
  ...
  serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
    const writer = w || new pb_1.BinaryWriter();
    if (this.ids.length) writer.writePackedInt32(1, this.ids);
    if (!w) return writer.getResultBuffer();
  }
...
export class BatchStringRequest extends pb_1.Message {
  ...
  static fromObject(data: { ids?: string[] }): BatchStringRequest {
  ...
  static deserialize(
    ...
    const reader =
        bytes instanceof pb_1.BinaryReader
          ? bytes
          : new pb_1.BinaryReader(bytes),
      message = new BatchStringRequest();
    while (reader.nextField()) {
      if (reader.isEndGroup()) break;
      switch (reader.getFieldNumber()) {
        case 1:
...
export class MediaMetaModel extends pb_1.Message {
  ...
  get type() {
    return pb_1.Message.getFieldWithDefault(
      this,
      2,
      dependency_1.MediaMetaType._MediaMetaType_UNSPECIFIED
    ) as dependency_1.MediaMetaType;
  }
  ...
  serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
    ...
    if (this.width != 0) writer.writeUint32(3, this.width);
    if (this.height != 0) writer.writeUint32(4, this.height);
    if (this.len != 0) writer.writeUint32(5, this.len);
    if (!w) return writer.getResultBuffer();
  }
...
export class UserAddressModel extends pb_1.Message {
  ...
  serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
    const writer = w || new pb_1.BinaryWriter();
    if (this.province.length) writer.writeString(1, this.province);
