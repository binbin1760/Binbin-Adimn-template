...
export class MerchantDetailModel extends pb_1.Message {
  ...
  static fromObject(data: {
    ...
    if (data.businessHours != null) {
      message.businessHours = data.businessHours.map((item) =>
        BusinessHourModel.fromObject(item)
      );
    }
  ...
  toObject() {
    ...
    if (this.businessHours != null) {
      data.businessHours = this.businessHours.map((item: BusinessHourModel) =>
        item.toObject()
      );
    }
  ...
  serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
    ...
    if (this.businessHours.length)
      writer.writeRepeatedMessage(
        6,
        this.businessHours,
        (item: BusinessHourModel) => item.serialize(writer)
      );
    if (this.hasAddress)
      writer.writeMessage(7, this.address, () =>
        this.address.serialize(writer)
      );
    if (this.phoneNumber.length)
      writer.writeRepeatedString(8, this.phoneNumber);
    if (this.distance != 0) writer.writeDouble(9, this.distance);
    if (this.isOnline != false) writer.writeBool(10, this.isOnline);
    if (this.pks.length)
      writer.writeRepeatedMessage(11, this.pks, (item: MerchantPKCell) =>
        item.serialize(writer)
      );
    if (this.merchantUid.length) writer.writeString(12, this.merchantUid);
  ...
  static deserialize(
    ...
    const reader =
      ...
      message = new MerchantDetailModel();
    while (reader.nextField()) {
      ...
      switch (reader.getFieldNumber()) {
        ...
        case 5:
          ...
          break;
        case 6:
          reader.readMessage(message.businessHours, () =>
            pb_1.Message.addToRepeatedWrapperField(
              message,
              6,
              BusinessHourModel.deserialize(reader),
              BusinessHourModel
            )
          );
          break;
        case 7:
          reader.readMessage(
            message.address,
            () => (message.address = MerchantAddressModel.deserialize(reader))
          );
          break;
        case 8:
        ...
        case 10:
          ...
          break;
        case 11:
          reader.readMessage(message.pks, () =>
            pb_1.Message.addToRepeatedWrapperField(
              message,
              11,
              MerchantPKCell.deserialize(reader),
              MerchantPKCell
            )
          );
          break;
...
export class MerchantPKCell extends pb_1.Message {
  ...
  serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
    ...
    if (this.tags.length) writer.writeRepeatedString(4, this.tags);
    if (this.sales != 0) writer.writeUint32(5, this.sales);
...
export class MerchantViewModel extends pb_1.Message {
  ...
  static fromObject(data: {
    ...
    phoneNumber?: string[];
    doorNumber?: string;
    businessLicense?: ReturnType<
      typeof dependency_2.MediaMetaModel.prototype.toObject
    >;
    identityDocuments?: ReturnType<
      typeof dependency_2.MediaMetaModel.prototype.toObject
    >[];
    theme?: ReturnType<typeof dependency_2.MediaMetaModel.prototype.toObject>;
    screenshots?: ReturnType<
    ...
    if (data.businessLicense != null) {
      message.businessLicense = dependency_2.MediaMetaModel.fromObject(
        data.businessLicense
      );
    }
    if (data.identityDocuments != null) {
      message.identityDocuments = data.identityDocuments.map((item) =>
        dependency_2.MediaMetaModel.fromObject(item)
      );
    }
    if (data.theme != null) {
  ...
  toObject() {
    ...
    if (this.identityDocuments != null) {
      data.identityDocuments = this.identityDocuments.map(
        (item: dependency_2.MediaMetaModel) => item.toObject()
      );
    }
    if (this.theme != null) {
  ...
  serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
    ...
    if (this.doorNumber.length) writer.writeString(6, this.doorNumber);
    if (this.hasBusinessLicense)
      writer.writeMessage(7, this.businessLicense, () =>
        this.businessLicense.serialize(writer)
      );
    ...
    if (this.tags.length) writer.writeRepeatedString(14, this.tags);
    if (this.rating != 0) writer.writeFloat(15, this.rating);
    if (this.isOnline != false) writer.writeBool(16, this.isOnline);
    if (!w) return writer.getResultBuffer();
  }
    ...
    while (reader.nextField()) {
      ...
      switch (reader.getFieldNumber()) {
        ...
        case 7:
          ...
          break;
        case 8:
          reader.readMessage(message.identityDocuments, () =>
            pb_1.Message.addToRepeatedWrapperField(
              message,
              8,
              dependency_2.MediaMetaModel.deserialize(reader),
...
export class MerchantAddressModel extends pb_1.Message {
  ...
  serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
    const writer = w || new pb_1.BinaryWriter();
    if (this.country.length) writer.writeString(1, this.country);
    if (this.province.length) writer.writeString(2, this.province);
    if (this.city.length) writer.writeString(3, this.city);
    if (this.district.length) writer.writeString(4, this.district);
    if (this.street.length) writer.writeString(5, this.street);
    if (this.latitude != 0) writer.writeDouble(6, this.latitude);
    if (this.longitude != 0) writer.writeDouble(7, this.longitude);
    if (!w) return writer.getResultBuffer();
  }
  static deserialize(
    bytes: Uint8Array | pb_1.BinaryReader
    ...
    const reader =
        bytes instanceof pb_1.BinaryReader
          ? bytes
          : new pb_1.BinaryReader(bytes),
      message = new MerchantAddressModel();
    while (reader.nextField()) {
      if (reader.isEndGroup()) break;
      switch (reader.getFieldNumber()) {
        case 1:
...
export class BusinessHourModel extends pb_1.Message {
  ...
  serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
    const writer = w || new pb_1.BinaryWriter();
    if (this.dayOfWeek != 0) writer.writeUint32(1, this.dayOfWeek);
    if (this.hasOpeningTime)
      writer.writeMessage(2, this.openingTime, () =>
        this.openingTime.serialize(writer)
      );
    if (this.hasClosingTime)
      writer.writeMessage(3, this.closingTime, () =>
        this.closingTime.serialize(writer)
      );
    if (!w) return writer.getResultBuffer();
  }
    ...
    while (reader.nextField()) {
      ...
      switch (reader.getFieldNumber()) {
        ...
        case 2:
          reader.readMessage(
            message.openingTime,
            () => (message.openingTime = LocalTimeModel.deserialize(reader))
          );
          break;
        case 3:
          reader.readMessage(
            message.closingTime,
            () => (message.closingTime = LocalTimeModel.deserialize(reader))
          );
          break;
        default:
          reader.skipField();
...
export class LocalTimeModel extends pb_1.Message {
  ...
  serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
    const writer = w || new pb_1.BinaryWriter();
    if (this.hour != 0) writer.writeUint32(1, this.hour);
    if (this.minute != 0) writer.writeUint32(2, this.minute);
    if (this.second != 0) writer.writeUint32(3, this.second);
    if (this.nanoOfSecond != 0) writer.writeUint64(4, this.nanoOfSecond);
    if (!w) return writer.getResultBuffer();
  }
...
export class UpdateMerchantOnlineRequest extends pb_1.Message {
  ...
  serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
    const writer = w || new pb_1.BinaryWriter();
    if (this.isOnline != 0) writer.writeUint32(1, this.isOnline);
  ...
  static deserialize(
    ...
    const reader =
        bytes instanceof pb_1.BinaryReader
          ? bytes
          : new pb_1.BinaryReader(bytes),
      message = new UpdateMerchantOnlineRequest();
    while (reader.nextField()) {
      if (reader.isEndGroup()) break;
      switch (reader.getFieldNumber()) {
        case 1:
  ...
  static deserialize(
    ...
    const reader =
        bytes instanceof pb_1.BinaryReader
          ? bytes
          : new pb_1.BinaryReader(bytes),
      message = new UpdateMerchantBusinessHourRequest();
    while (reader.nextField()) {
      if (reader.isEndGroup()) break;
      switch (reader.getFieldNumber()) {
        case 11:
