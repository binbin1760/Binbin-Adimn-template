...
export class PetBreedViewModel extends pb_1.Message {
    ...
    get theme() {
        return pb_1.Message.getWrapperField(this, dependency_1.MediaMetaModel, 3) as dependency_1.MediaMetaModel;
    }
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): PetBreedViewModel {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new PetBreedViewModel();
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    reader.readMessage(message.theme, () => message.theme = dependency_1.MediaMetaModel.deserialize(reader));
                    break;
                case 4:
...
export class PetViewModel extends pb_1.Message {
    ...
    get gender() {
        return pb_1.Message.getFieldWithDefault(this, 2, dependency_3.Gender._Gender_UNSPECIFIED) as dependency_3.Gender;
    }
    ...
    get avatar() {
        return pb_1.Message.getWrapperField(this, dependency_1.MediaMetaModel, 9) as dependency_1.MediaMetaModel;
    }
    ...
    get album() {
        return pb_1.Message.getRepeatedWrapperField(this, dependency_1.MediaMetaModel, 10) as dependency_1.MediaMetaModel[];
    }
    ...
    static fromObject(data: {
        ...
        if (data.album != null) {
            message.album = data.album.map(item => dependency_1.MediaMetaModel.fromObject(item));
        }
        return message;
    }
    toObject() {
        ...
        if (this.album != null) {
            data.album = this.album.map((item: dependency_1.MediaMetaModel) => item.toObject());
        }
        return data;
    }
    serialize(): Uint8Array;
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.breedId.length)
            writer.writeString(6, this.breedId);
        if (this.breadTitle.length)
            writer.writeString(7, this.breadTitle);
        if (this.weight != 0)
            writer.writeFloat(8, this.weight);
        if (this.hasAvatar)
            writer.writeMessage(9, this.avatar, () => this.avatar.serialize(writer));
        if (this.album.length)
            writer.writeRepeatedMessage(10, this.album, (item: dependency_1.MediaMetaModel) => item.serialize(writer));
        if (!w)
            return writer.getResultBuffer();
    }
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): PetViewModel {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new PetViewModel();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
                ...
                case 8:
                    ...
                    break;
                case 9:
                    reader.readMessage(message.avatar, () => message.avatar = dependency_1.MediaMetaModel.deserialize(reader));
                    break;
                case 10:
                    reader.readMessage(message.album, () => pb_1.Message.addToRepeatedWrapperField(message, 10, dependency_1.MediaMetaModel.deserialize(reader), dependency_1.MediaMetaModel));
                    break;
                default: reader.skipField();
            }
        }
...
export class UploadAlbumRequest extends pb_1.Message {
    ...
    get raws() {
        return pb_1.Message.getRepeatedWrapperField(this, dependency_1.MediaMetaModel, 1) as dependency_1.MediaMetaModel[];
    }
    ...
    static fromObject(data: {
        ...
        if (data.raws != null) {
            message.raws = data.raws.map(item => dependency_1.MediaMetaModel.fromObject(item));
        }
        return message;
    }
    toObject() {
        ...
        if (this.raws != null) {
            data.raws = this.raws.map((item: dependency_1.MediaMetaModel) => item.toObject());
        }
        return data;
    }
    serialize(): Uint8Array;
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        const writer = w || new pb_1.BinaryWriter();
        if (this.raws.length)
            writer.writeRepeatedMessage(1, this.raws, (item: dependency_1.MediaMetaModel) => item.serialize(writer));
        if (!w)
            return writer.getResultBuffer();
    }
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): UploadAlbumRequest {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new UploadAlbumRequest();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
                case 1:
                    reader.readMessage(message.raws, () => pb_1.Message.addToRepeatedWrapperField(message, 1, dependency_1.MediaMetaModel.deserialize(reader), dependency_1.MediaMetaModel));
                    break;
                default: reader.skipField();
            }
        }
