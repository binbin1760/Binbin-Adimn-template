...
export class TableCmsUsrFilterRequest extends pb_1.Message {
    ...
    get status() {
        return pb_1.Message.getFieldWithDefault(this, 2, dependency_1.Status._Status_UNSPECIFIED) as dependency_1.Status;
    }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.blurry.length)
            writer.writeString(3, this.blurry);
        if (!w)
            return writer.getResultBuffer();
    }
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): TableCmsUsrFilterRequest {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new TableCmsUsrFilterRequest();
...
export class TableCmsUsrFilterResponse extends pb_1.Message {
    ...
    get raws() {
        return pb_1.Message.getRepeatedWrapperField(this, TableCmsUserModel, 2) as TableCmsUserModel[];
    }
    ...
    static fromObject(data: {
        ...
        if (data.raws != null) {
            message.raws = data.raws.map(item => TableCmsUserModel.fromObject(item));
        }
        return message;
    }
    toObject() {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.hasPage)
            writer.writeMessage(1, this.page, () => this.page.serialize(writer));
        if (this.raws.length)
            writer.writeRepeatedMessage(2, this.raws, (item: TableCmsUserModel) => item.serialize(writer));
        if (!w)
            return writer.getResultBuffer();
    }
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): TableCmsUsrFilterResponse {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new TableCmsUsrFilterResponse();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
                case 1:
                    ...
                    break;
                case 2:
                    reader.readMessage(message.raws, () => pb_1.Message.addToRepeatedWrapperField(message, 2, TableCmsUserModel.deserialize(reader), TableCmsUserModel));
                    break;
                default: reader.skipField();
            }
        }
...
export class TableCmsUserModel extends pb_1.Message {
    ...
    get gender() {
        return pb_1.Message.getFieldWithDefault(this, 4, dependency_1.Gender._Gender_UNSPECIFIED) as dependency_1.Gender;
    }
    set gender(value: dependency_1.Gender) {
        pb_1.Message.setField(this, 4, value);
    }
    get avatar() {
        return pb_1.Message.getWrapperField(this, dependency_3.MediaMetaModel, 5) as dependency_3.MediaMetaModel;
    }
    ...
    get status() {
        return pb_1.Message.getFieldWithDefault(this, 6, dependency_1.Status._Status_UNSPECIFIED) as dependency_1.Status;
    }
    set status(value: dependency_1.Status) {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.roles.length)
            writer.writeRepeatedString(7, this.roles);
        if (!w)
            return writer.getResultBuffer();
    }
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): TableCmsUserModel {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new TableCmsUserModel();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    reader.readMessage(message.avatar, () => message.avatar = dependency_3.MediaMetaModel.deserialize(reader));
                    break;
                case 6:
                    message.status = reader.readEnum();
                    break;
...
export class CmsUsrRoleRequest extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.roleIds.length)
            writer.writeRepeatedString(2, this.roleIds);
        if (!w)
            return writer.getResultBuffer();
    }
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): CmsUsrRoleRequest {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new CmsUsrRoleRequest();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
