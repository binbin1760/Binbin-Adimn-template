...
export class TableCmsPurchasePackageFilterRequest extends pb_1.Message {
    ...
    get stat() {
        return pb_1.Message.getFieldWithDefault(this, 4, dependency_1.ApprovalStat._ApprovalStat_UNSPECIFIED) as dependency_1.ApprovalStat;
    }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.categories.length)
            writer.writePackedInt32(3, this.categories);
        if (this.stat != dependency_1.ApprovalStat._ApprovalStat_UNSPECIFIED)
            writer.writeEnum(4, this.stat);
        if (!w)
            return writer.getResultBuffer();
    }
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): TableCmsPurchasePackageFilterRequest {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new TableCmsPurchasePackageFilterRequest();
    ...
    static deserializeBinary(bytes: Uint8Array): TableCmsPurchasePackageFilterRequest {
...
export class TableCmsPurchasePackageFilterResponse extends pb_1.Message {
    ...
    get raws() {
        return pb_1.Message.getRepeatedWrapperField(this, TableCmsPurchasePackageViewModel, 2) as TableCmsPurchasePackageViewModel[];
    }
    ...
    static fromObject(data: {
        ...
        raws?: ReturnType<typeof TableCmsPurchasePackageViewModel.prototype.toObject>[];
        ...
        if (data.raws != null) {
            message.raws = data.raws.map(item => TableCmsPurchasePackageViewModel.fromObject(item));
        }
        return message;
    }
    toObject() {
        ...
        if (this.raws != null) {
            data.raws = this.raws.map((item: TableCmsPurchasePackageViewModel) => item.toObject());
        }
        return data;
    }
    serialize(): Uint8Array;
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.hasPage)
            writer.writeMessage(1, this.page, () => this.page.serialize(writer));
        if (this.raws.length)
            writer.writeRepeatedMessage(2, this.raws, (item: TableCmsPurchasePackageViewModel) => item.serialize(writer));
        if (!w)
            return writer.getResultBuffer();
    }
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): TableCmsPurchasePackageFilterResponse {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new TableCmsPurchasePackageFilterResponse();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
                case 1:
                    ...
                    break;
                case 2:
                    reader.readMessage(message.raws, () => pb_1.Message.addToRepeatedWrapperField(message, 2, TableCmsPurchasePackageViewModel.deserialize(reader), TableCmsPurchasePackageViewModel));
                    break;
                default: reader.skipField();
            }
        }
    ...
    static deserializeBinary(bytes: Uint8Array): TableCmsPurchasePackageFilterResponse {
...
export class TableCmsPurchasePackageViewModel extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.merchant.length)
            writer.writeString(3, this.merchant);
        if (this.categories.length)
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): TableCmsPurchasePackageViewModel {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new TableCmsPurchasePackageViewModel();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
    ...
    static deserializeBinary(bytes: Uint8Array): TableCmsPurchasePackageViewModel {
