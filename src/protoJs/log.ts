...
export class SysLogPageRequest extends pb_1.Message {
    ...
    get type() {
        return pb_1.Message.getFieldWithDefault(this, 2, dependency_1.LogErrorType._LogErrorType_UNSPECIFIED) as dependency_1.LogErrorType;
    }
    set type(value: dependency_1.LogErrorType) {
        pb_1.Message.setField(this, 2, value);
    }
    get range() {
        return pb_1.Message.getWrapperField(this, dependency_3.TimeRange, 3) as dependency_3.TimeRange;
    }
    ...
    get page() {
        return pb_1.Message.getWrapperField(this, dependency_2.PagerRequest, 4) as dependency_2.PagerRequest;
    }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.blurry.length)
            writer.writeString(1, this.blurry);
    ...
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): SysLogPageRequest {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new SysLogPageRequest();
        while (reader.nextField()) {
            ...
            switch (reader.getFieldNumber()) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    reader.readMessage(message.range, () => message.range = dependency_3.TimeRange.deserialize(reader));
                    break;
                case 4:
...
export class SysLogPageResponse extends pb_1.Message {
    ...
    get raws() {
        return pb_1.Message.getRepeatedWrapperField(this, SysLogViewModel, 2) as SysLogViewModel[];
    }
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.raws.length)
            writer.writeRepeatedMessage(2, this.raws, (item: SysLogViewModel) => item.serialize(writer));
        if (!w)
            return writer.getResultBuffer();
    }
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): SysLogPageResponse {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new SysLogPageResponse();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
                case 1:
                    ...
                    break;
                case 2:
                    reader.readMessage(message.raws, () => pb_1.Message.addToRepeatedWrapperField(message, 2, SysLogViewModel.deserialize(reader), SysLogViewModel));
                    break;
                default: reader.skipField();
            }
        }
...
export class SysLogViewModel extends pb_1.Message {
    ...
    serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
        ...
        if (this.httpMethod.length)
            writer.writeString(5, this.httpMethod);
        if (this.className.length)
            writer.writeString(6, this.className);
        if (this.classMethod.length)
            writer.writeString(7, this.classMethod);
        if (this.description.length)
            writer.writeString(8, this.description);
        if (this.detail.length)
            writer.writeString(9, this.detail);
        if (this.args.length)
            writer.writeString(10, this.args);
        if (this.ip.length)
            writer.writeString(11, this.ip);
        if (this.address.length)
            writer.writeString(12, this.address);
        if (this.duration != 0)
            writer.writeUint64(13, this.duration);
        if (this.occurAt != 0)
            writer.writeInt64(14, this.occurAt);
        if (!w)
            return writer.getResultBuffer();
    }
    static deserialize(bytes: Uint8Array | pb_1.BinaryReader): SysLogViewModel {
        const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new SysLogViewModel();
        while (reader.nextField()) {
            if (reader.isEndGroup())
                break;
            switch (reader.getFieldNumber()) {
